    ...
    <section className="max-w-7xl mx-auto pt-32 pb-14 px-8">
      ...
      <div className="mt-10">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <span className="px-5 py-2 rounded-full bg-purple-600/20 border border-purple-500/30 text-purple-300">
